...
export async function insertHintRequest(puzzleId: string, hint: string) {
  ...
  const hintMessage = `🙏 **Hint** [request](https://www.${HUNT_DOMAIN}/admin/hints/${result.id}) by [${teamId}](https://www.${HUNT_DOMAIN}/team/${teamId}) on [${puzzleId}](https://www.${HUNT_DOMAIN}/puzzle/${puzzleId} ): ${hint} <@&1310029428864057504>`;
