...
6. Add the original repository as a remote branch `bph-site`.

   ```
   git remote add bph-site https://github.com/brown-puzzle-hq/bph-site.git
   ```
...
```ts file=tailwind.config.ts:22-47
colors: {
...
```ts file=src/app/(hunt)/puzzle/components/puzzle/guess/actions.ts:149-153
