        ...
        <article className="prose mx-auto min-h-screen max-w-[80ch]">
          ...
          >
            ...
            <p>
              ...
              Puzzles can come in many different forms; the only commonality is
              that there are usually no direct instructions, so it is up to you
              to extract an English word from the information given. You can
          ...
          <TOCSection sectionId={1} tocTitle="Who can participate?">
            ...
            <p>
              ...
              current Brown/RISD student on-campus. If you do not have a current
              Brown/RISD student on your team, you will be able to do the final
              runaround, but you will not be able to win.
            </p>
          </TOCSection>
          <TOCSection
            sectionId={2}
          ...
          >
            ...
            <p>
              Brown Puzzlehunt is available both as an in-person event and as an
              online event. The in-person event will being on [DATE] from [TIME]
              to [TIME]. The online event will begin a week later, on [DATE]
              from [TIME] to [TIME]. These events are split into two different
              weeks so we can deliver a better hunt experience!
            </p>
            <p>
              The main difference between the in-person and the online event is
              kickoff, access to physical puzzles, and runarounds. While
              physical events are not are not essential to finish, they will be
              fun and will help you progress.
            </p>
            <h3>In-person timeline</h3>
            <p>
              The in-person event is on [DATE] from [TIME] to [TIME] at Brown
              University in Providence, Rhode Island.{" "}
              <strong>If you are a non-Brown/RISD participant,</strong> you will
          ...
          <TOCSection sectionId={3} tocTitle="How do puzzles work?">
            ...
            <p>
              ...
              available at the start of the hunt, and some puzzles will be
              unlocked after solving another puzzles.
            </p>
            <p>
          ...
          <TOCSection sectionId={4} tocTitle="How do hints work?">
            ...
            <p>
              ...
              puzzle. This can be something like a nudge in the right direction
              (i.e. you give us your progress on the puzzle and we will try to
              get you unstuck) or an answer to a question (e.g. “Which answers
              to these crossword clues are wrong?”). You can only have one open
            ...
            <p>
              ...
              frequently to check on your progress and help you along. If you
              are struggling, do not hesitate to reach out — the event is meant
              to be fun, and we want to ensure no hunter is left behind! If you
              want someone on HQ to come and visit you, you can email us at any
              time.
            </p>
          </TOCSection>
          <TOCSection sectionId={5} tocTitle="What else?">
            ...
            <p>
              ...
              contact us for any reason, feel free to email us at brownpuzzleHQ
              [at] gmail [dot] com.
            </p>
          </TOCSection>
        </article>
